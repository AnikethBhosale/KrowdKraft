  ...
  const stars = [
    {
      ...
      height: 44,
      background:
        "radial-gradient(circle at 30% 30%, rgba(99,102,241,0.95), rgba(99,102,241,0.08))",
    ...
    },
    {
      ...
      height: 32,
      background:
        "radial-gradient(circle at 30% 30%, rgba(204,102,255,0.95), rgba(204,102,255,0.06))",
    ...
    },
    {
      ...
      height: 36,
      background:
        "radial-gradient(circle at 30% 30%, rgba(245,158,11,0.95), rgba(245,158,11,0.06))",
    ...
    },
    {
      ...
      height: 28,
      background:
        "radial-gradient(circle at 30% 30%, rgba(56,189,248,0.95), rgba(56,189,248,0.06))",
      ...
      {stars.map((s, i) => (
        <span
          ...
          style={{
            ...
            opacity: 0.9,
            pointerEvents: "none",
            animation: `starPulse ${3 + i * 0.6}s ease-in-out infinite ${
              i * 0.1
            }s`,
          }}
        />
  ...
  return (
    <div className="border border-border/40 rounded-lg overflow-hidden">
      {[...Array(6)].map((_, i) => (
        <div
          key={i}
          className="flex items-start gap-4 py-4 px-4 border-b border-border/40 animate-pulse"
        >
          <div className="flex items-center gap-3 min-w-fit">
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-nowrap">
            Join our open-source community! Browse active issues and contribute
            to KrowdKraft.
          </p>
        </motion.div>
        ...
        >
          <div className="relative flex justify-center mb-6">
            <h3 className="relative spotlight-title text-2xl sm:text-3xl font-semibold px-4">
              Contributor Spotlight
            </h3>
          </div>
          ...
          >
            <div className="inline-flex items-center gap-2 glass-card px-6 py-3">
              ...
              <span className="text-muted-foreground">
                <span className="font-bold text-neon">{totalCount}</span> open
                issues
              </span>
            </div>
          </motion.div>
          ...
          >
            <div className="glass-card p-8 max-w-md mx-auto">
              ...
              <p className="text-muted-foreground mb-4">
                We couldn't fetch the latest issues from GitHub. Please try
                again later.
              </p>
        ...
        {!isLoading && !error && issues.length > 0 && (
          <>
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className=" grid grid-cols-1 md:grid-cols-2 gap-4 p-4 border border-border/40 rounded-lg  mb-8 bg-background/50"
            >
          ...
          >
            <div className="glass-card p-8 max-w-md mx-auto">
              ...
              <p className="text-muted-foreground">
                Great news! All issues are resolved. Check back later for new
          ...
          <div className="glass-card p-6 max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-4 flex-1">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Check out our repository on GitHub to get started. Every
                    contribution helps us build something amazing together.
                  </p>
                </div>
              </div>
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://github.com/DarshanKrishna-DK/KrowdKraft",
                    "_blank"
                  )
                }
